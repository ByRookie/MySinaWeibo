...
import com.huliang.weibo.adapter.StatusCommentAdapter;
import com.huliang.weibo.adapter.StatusGridImgsAdapter;
...
import com.huliang.weibo.entity.response.CommentsResponse;
import com.huliang.weibo.utils.DateUtils;
import com.huliang.weibo.utils.ImageOptHelper;
import com.huliang.weibo.utils.Logger;
...
public class StatusDetailActivity extends Activity implements
    ...
    private void initDetailHead() {
        ...
        iv_image.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(StatusDetailActivity.this, ShowImageActivity.class);
                String url = (String) v.getTag();
                intent.putExtra("ImageURL", url);
                startActivity(intent);
            }
        });
        iv_retweeted_image.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(StatusDetailActivity.this, ShowImageActivity.class);
                String url = (String) v.getTag();
        ...
        gv_retweeted_images.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(StatusDetailActivity.this, ShowImageActivity.class);
                StatusGridImgsAdapter.ViewHolder viewHolder = (StatusGridImgsAdapter.ViewHolder) view.getTag();
    ...
    private void setImages(final Status status, ViewGroup vgContainer, GridView gvImgs, final ImageView ivImg) {
        ...
        if (picUrls != null && picUrls.size() == 1) {
            ...
            ivImg.setTag(status.getOriginal_pic());
        ...
        weiboApi.commentsShow(status.getId(), requestPage,
                new SimpleRequestListener(this, null) {
                    ...
                    public void onComplete(String response) {
                        ...
                        Logger.show("StatusDetailActivity", "status comments = " + response);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.ll_share_bottom:
                intent = new Intent(StatusDetailActivity.this, WriteStatusActivity.class);
            ...
            case R.id.ll_like_bottom:
                ToastUtils.showToast(StatusDetailActivity.this, "点赞，由于受系统API限制，故未开放", Toast.LENGTH_SHORT);
                break;
            default:
                break;
        }
