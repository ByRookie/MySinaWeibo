...
import com.huliang.weibo.constants.URLs;
...
public class BoreWeiboApi extends WeiboAPI {
     ...
     * @param listener
     */
    public void statusesPublic_timeline(RequestListener listener) {
        WeiboParameters parameters = new WeiboParameters();
        requestInMainLooper(URLs.statusesPublic_timeline, parameters, HTTPMETHOD_GET, listener);
    }
     ...
     * @param listener
     */
    public void favroits(RequestListener listener) {
        WeiboParameters parameters = new WeiboParameters();
        requestInMainLooper(URLs.favorites, parameters, HTTPMETHOD_GET, listener);
    }
